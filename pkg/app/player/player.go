...
func (p *Player) initChipData() {
	if config.Get().Debug.UseDebugFolder {
		...
		p.ChipFolder = [FolderSize]ChipInfo{
			{ID: chip.IDDeathMatch1, Code: "*"},
			{ID: chip.IDVulcan1, Code: "*"},
			{ID: chip.IDSpreadGun, Code: "*"},
			{ID: chip.IDHeatV, Code: "*"},
			{ID: chip.IDBubbleSide, Code: "*"},
			{ID: chip.IDThunderBall1, Code: "*"},
			{ID: chip.IDWideShot1, Code: "*"},
			{ID: chip.IDFlameLine1, Code: "*"},
			{ID: chip.IDTornado, Code: "*"},
			{ID: chip.IDMiniBomb, Code: "*"},
			{ID: chip.IDLongSword, Code: "*"},
			{ID: chip.IDBoomerang1, Code: "*"},
			{ID: chip.IDBambooLance, Code: "*"},
			{ID: chip.IDCountBomb, Code: "*"},
			{ID: chip.IDDoubleCrack, Code: "*"},
			{ID: chip.IDRecover50, Code: "*"},
			{ID: chip.IDAreaSteal, Code: "*"},
			{ID: chip.IDDeathMatch2, Code: "*"},
			{ID: chip.IDQuickGauge, Code: "*"},
			{ID: chip.IDInvisible, Code: "*"},
			{ID: chip.IDBarrier, Code: "*"},
			{ID: chip.IDAttack10, Code: "*"},
			{ID: chip.IDForteAnother, Code: "*"},
