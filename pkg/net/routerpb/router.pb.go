...
type Action_SeType struct {
	SeType int64 `protobuf:"varint,9,opt,name=seType,proto3,oneof"`
}
...
var file_router_proto_rawDesc = []byte{
	...
	0x65, 0x54, 0x79, 0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x06, 0x73,
